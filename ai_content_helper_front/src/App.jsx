...
export default function App() {
  ...
  return (
    <div className="bg-[#0b0f19] min-h-screen flex flex-col justify-center relative overflow-x-hidden antialiased text-slate-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full py-8 md:py-12">
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <p className="text-slate-400 text-sm md:text-base max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Пишите вовлекающие посты для Telegram, структурированные статьи
              для VC.ru и емкие мысли для X (Twitter).
            </p>
